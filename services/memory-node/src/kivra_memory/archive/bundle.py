    ...
    def create(
        ...
        *,
        ...
        with tempfile.TemporaryDirectory(
            ...
            self._git(source.repository, ("bundle", "verify", str(plaintext)))
            ...
            _publish_new_file(ciphertext, destination)
            published_digest, published_size = _hash_regular_file(destination)
            if published_digest != ciphertext_digest or published_size != ciphertext_size:
